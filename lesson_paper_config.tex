...
\setsansfont{Source-Sans-Pro.ttf}
...
\setlength{\parskip}{0.5em}  % 段落之间空 0.5 行
...
\renewcommand\section{\@startsection{section}{1}{0pt}%
	...
	{.5ex \@plus .1ex}%
	{\normalfont\sihao\fang\raggedright}}  %%这边要是不想要宋体三号字，可以把song改成之前定义的字体和字号。
...
\renewcommand\subsection{\@startsection{subsection}{1}{0pt}%
	...
	{.4ex \@plus .1ex}%
	{\normalfont\wuhao\hei\raggedright}}
\makeatother
%%%% 设置 subsubsection 属性 %%%%
\makeatletter
